...
public class RoleController implements RoleRestControllerApi{
	...
	public ResponseEntity<?> buscarRolePorId(@PathVariable("id") Long id) {
		...
		mensagem.showMensagem("Papel encontrado com sucesso", HttpStatus.OK.value(),role);
	...
	public ResponseEntity<?> salvarRole(@RequestBody Role role) {
		...
		mensagem.showMensagem("Papel cadastrado com sucesso", HttpStatus.OK.value(),role);
	...
	public ResponseEntity<?> alterarRole(@PathVariable("id") Long id, @RequestBody Role role) {
		...
		mensagem.showMensagem("Papel alterado com sucesso", HttpStatus.OK.value(),roleCadastrado);
		return ResponseEntity.ok().body(mensagem);
	}
	...
	public ResponseEntity<?> excluirRole(@PathVariable("id") Long id) {
		...
		mensagem.showMensagem("Papel excluido com sucesso", HttpStatus.OK.value(),null);
		return ResponseEntity.ok().body(mensagem);
	}


	@Override
	public Page<Role> listaPaginada(Integer page, Integer pageSize, String dir, String props) {
	...
	@Override
	public Page<Role> listaPagiadaPornome(Integer page, Integer pageSize, String dir, String props) {
		// TODO Auto-generated method stub
		return null;
	}
